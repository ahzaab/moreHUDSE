...
AHZLookupMap CAHZVanillaFormTable::CreateACTIBaseMap()
{
    AHZLookupMap m;
...
AHZLookupMap CAHZVanillaFormTable::CreateACTITargetMap()
{
    AHZLookupMap m;
...
VMScriptEntries CAHZVanillaFormTable::CreateVMVariables()
{
    VMScriptEntries v;
...
void CAHZVanillaFormTable::LoadACTIForms(CAHZFormLookup& loader)
{
...
void CAHZVanillaFormTable::LoadVMVariables(CAHZFormLookup& loader)
{
