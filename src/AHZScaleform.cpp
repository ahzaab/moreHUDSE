...
//            if (auto extraEnchant = static_cast<RE::ExtraEnchantment*>(target.GetReference()->extraList.GetByType(RE::ExtraDataType::kEnchantment))) {
//                wasExtra = true;
...
//}
//
//auto CAHZScaleform::GetWeaponDamageDiff(CAHZTarget &target) -> float
//{
...
//        return 0.0f;
//
//    targetWeapon = CAHZWeaponInfo::GetWeaponInfo(target);
...
//}
//
//auto CAHZScaleform::GetIngredient(CAHZTarget &target) -> RE::IngredientItem*
//{
//    if (!target.IsValid())
//        return nullptr;
//
...
//}
//
//auto CAHZScaleform::GetSpellItem(CAHZTarget &target) -> RE::SpellItem*
//{
//    if (!target.IsValid())
//        return nullptr;
//
...
//}
//
//auto CAHZScaleform::GetAlchemyItem(CAHZTarget &target) -> RE::AlchemyItem*
//{
//    if (!target.IsValid())
//        return nullptr;
//
...
//        displayName = extraList.GetDisplayName(target.GetForm()->As<RE::TESBoundObject>());
//    }
//
...
//
//        if (target.IsReference()) {
//            if (auto extraEnchant = static_cast<RE::ExtraEnchantment*>(target.GetReference()->extraList.GetByType(RE::ExtraDataType::kEnchantment)))  // Enchanted
//            {
...
//            warmthRating = GetArmorWarmthRating(target);
//        }
//    }
//
...
//    float weight = target.GetForm()->GetWeight();
//    if (target.IsReference() && target.GetReference()->extraList.HasType(RE::ExtraDataType::kCount)) {
//        auto xCount = static_cast<RE::ExtraCount*>(target.GetReference()->extraList.GetByType(RE::ExtraDataType::kCount));
//        if (xCount) {
...
//    RegisterNumber(&obj, "formType", static_cast<uint32_t>(target.GetForm()->GetFormType()));
...
bool CAHZScaleform::GetIsBookAndWasRead(CAHZTarget &target) {
    bool returnValue{};
    return returnValue;
}
...
uint32_t CAHZScaleform::GetIsKnownEnchantment(CAHZTarget &target) {
...
float CAHZScaleform::GetArmorWarmthRating(CAHZTarget &target) {
    float returnValue{};
    return returnValue;
}
...
string CAHZScaleform::GetTargetName(CAHZTarget &target) {
    string returnValue{};
    return returnValue;
}

string CAHZScaleform::GetArmorWeightClass(CAHZTarget &target) {
    string returnValue{};
    return returnValue;
}

string CAHZScaleform::GetEffectsDescription(CAHZTarget &target) {
    string returnValue{};
    return returnValue;
}

string CAHZScaleform::GetBookSkill(CAHZTarget &target) {
    string returnValue{};
    return returnValue;
}

string CAHZScaleform::GetValueToWeight(const char* stringFromHUD, const char* vmTranslated) {
    string returnValue{};
    return returnValue;
}
...
float CAHZScaleform::GetArmorRatingDiff(CAHZTarget &target) {
    float returnValue{};
    return returnValue;
}

float CAHZScaleform::GetWarmthRatingDiff(CAHZTarget &target) {
    float returnValue{};
    return returnValue;
}

float CAHZScaleform::GetWeaponDamageDiff(CAHZTarget &target) {
    float returnValue{};
    return returnValue;
}

float CAHZScaleform::GetTotalActualWeaponDamage() {
    float returnValue{};
    return returnValue;
}
...
void CAHZScaleform::BuildInventoryObject(CAHZTarget &target, RE::GFxFunctionHandler::Params& arg) {
}
...
float CAHZScaleform::mRound(float d) {
    float returnValue{};
    return returnValue;
}

RE::IngredientItem* CAHZScaleform::GetIngredient(CAHZTarget &target) {
    RE::IngredientItem* returnValue{};
    return returnValue;
}
...
RE::AlchemyItem* CAHZScaleform::GetAlchemyItem(CAHZTarget &target) {
    RE::AlchemyItem* returnValue{};
    return returnValue;
}
...
RE::SpellItem* CAHZScaleform::GetSpellItem(CAHZTarget &target) {
    RE::SpellItem* returnValue{};
    return returnValue;
}
