...
$destinationDataPath = "$($Env:ModDevPath)\MODS\SkyrimSE\moreHUD\StandAlone\moreHUD\dist\Data"
$destinationAS2Path = "$($Env:ModDevPath)\MODS\SkyrimSE\moreHUD\StandAlone\moreHUD\dist\AS2"
