...
namespace moreHUDSE
{
    namespace SE
    {
        namespace Offsets
        {
            ...
            constexpr REL::ID BuildEquippedArmorComparisonContext{ 50948 };
            constexpr REL::ID CalculateItemComparison{ 50949 };
            constexpr REL::ID DestroyEquippedArmorComparisonContext{ 50239 };
